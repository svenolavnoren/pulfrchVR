...
APP_NAME = "pulfrichVR"
APP_VERSION = "0.9-090"
#last change: --0 first attempt tidy the code for the compass lines
#             --1 reformatted import statements to wider lines. while doing so I twice removed suspect last "," before ")"
